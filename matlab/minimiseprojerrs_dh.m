...
options=optimset('LargeScale','off','Algorithm','levenberg-marquardt','Display','off', 'TolFun',1e-6,'TolX',1e-6,'MaxFunEvals',30000,'MaxIter',1000,'PlotFcn','optimplotresnorm');
